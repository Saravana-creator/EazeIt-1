...
const Navbar = () => {
  ...
  // â”€â”€ Cart hook â€“ provides real-time cart count â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  const { cartCount } = useCart();

  // â”€â”€ Close dropdown on outside click â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  useEffect(() => {
            ...
            <div className="d-none d-md-flex align-items-center gap-3 shrink-0">
                ...
                {user ? (
                  <div className="d-flex align-items-center gap-2">
                    {/* Admin badge â€” shield icon only, no text */}
                    {user.role === 'admin' && (
                      <Link
                        to="/admin"
                        title="Admin Panel"
                    ...
                    {/* Profile avatar â€” click opens dropdown */}
                    <div className="position-relative" ref={profileRef}>
                      <button
                        onClick={() => setIsProfileOpen((v) => !v)}
                        title={`${user.firstName} ${user.lastName} â€” View Profile`}
